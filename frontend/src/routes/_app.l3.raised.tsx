...
export const Route = createFileRoute("/_app/l3/raised")({ component: L3RaisedTickets });

function L3RaisedTickets() {
  ...
  const designation = getSubRoleLabel(user.subRole);
  const workspaceTitle = `${designation} Raised Tickets`;
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Track and manage tickets you have raised in the system."
      />
