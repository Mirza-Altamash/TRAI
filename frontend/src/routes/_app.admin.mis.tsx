...
function MisPage() {
  ...
  async function handleExport(kind: "Excel" | "PDF") {
    ...
    try {
      ...
      const divRows = data.byDivision.map((d: any) => [d.name, d.count]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="MIS Reports"
        subtitle="Periodic management information across divisions, employees and tickets."
        actions={
        ...
        <TabsContent value={period} className="mt-4 space-y-4">
          {data && (
            <>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">Tickets by Division ({period})</CardTitle>
                </CardHeader>
                <CardContent>
