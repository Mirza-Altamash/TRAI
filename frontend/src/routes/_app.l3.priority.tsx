...
import { getMyPriorityTickets } from "@/services/ticketApi";
...
export const Route = createFileRoute("/_app/l3/priority")({ component: L3PriorityTickets });

function L3PriorityTickets() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Track and manage tickets you have marked as priority."
      />
