      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {type && type !== "New Development" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Specify details about the portal or report to be modified.
              </CardDescription>
            </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide a concise summary and detailed explanation of the request.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Field label="Title / Subject" error={errors.summary?.message}>
              <Input
                placeholder="Brief title of the issue or feature request"
                {...register("summary")}
              />
            </Field>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload any supporting documents, logs, or screenshots.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl p-6 bg-slate-50/50 dark:bg-slate-950/20">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Supports Doc, PDF, Excel, ZIP, images up to 10MB
              </p>
              <Button
                type="button"
                variant="secondary"
        ...
        <div className="flex justify-end gap-3 pt-2">
          <Button
            type="button"
            variant="outline"
            onClick={() => navigate({ to: "/l2/assignments" })}
          >
            Cancel
          </Button>
