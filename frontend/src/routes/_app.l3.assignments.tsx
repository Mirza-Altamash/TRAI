...
export const Route = createFileRoute("/_app/l3/assignments")({ component: L3Assignments });

function L3Assignments() {
  ...
  const workspaceTitle = `${designation} Personal Assignments`;
